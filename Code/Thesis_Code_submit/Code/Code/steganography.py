...
def write_new(input_image_path,output_image_path,text):
      Steganography.encode(input_image_path, output_image_path, text)

def read_new(input_image_path):
     return Steganography.decode(input_image_path)
